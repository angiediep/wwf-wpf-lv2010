...
namespace DataLayer.DAO
{
    public class DaoNhanVienThuaHanh
    {
        ...
        public List<string> getNVTreHan()
        {
            DataConnector dc = new DataConnector(); string conStr = dc.getQuyTrinhThiConnectionString();
            SqlConnection con = new SqlConnection(conStr);
            string sql = " select nv.tenNV, Month(td.ngayKetThucThucTe), Year(ngayKetThucThucTe ) from NhanVienThuaHanh nv, tienDo td where nv.maNV = td.maNV and td.ngayKetThucThucTe > td.ngayKetThucQuyDinh";
        ...
        public List<string> getNVTreHan(string tenDT)
        {
            DataConnector dc = new DataConnector(); string conStr = dc.getQuyTrinhThiConnectionString();
            SqlConnection con = new SqlConnection(conStr);
            string sql = "select cv.tenCV, td.khoiLuongCVHT,  nv.tenNV, gc.GhiChu from TienDo td, CongViec cv, NhanVienThuaHanh nv, DOTTHI dt, GhiChu gc where td.maDT = dt.maDT and cv.maCV = td.maCV and nv.maNV = td.maNV and gc.maTD = td.maTD and td.ngayKetThucThucTe > td.ngayKetThucQuyDinh and dt.tenDotThi = @tenDT";
            SqlCommand cmd = new SqlCommand(sql, con);
        ...
        public int getMaNVByTenNV(string tenNV)
        {
            DataConnector dc = new DataConnector(); string conStr = dc.getQuyTrinhThiConnectionString();
            SqlConnection con = new SqlConnection(conStr);
            string sql = "select maNV from NhanVienThuaHanh where tenDangNhap = @Ten";
            SqlCommand cmd = new SqlCommand(sql, con);
