...
public class BusNhanVien
{
    ...
    public DataTable getDataTable()
    {
        ...
        try
        {
            DaoNhanVien data = new DaoNhanVien();
	...
	public List<DtoNhanVien> getListDataBytenDangNhap(string tenDangNhap)
	{
		...
		{
			DaoNhanVien dNhanVien = new DaoNhanVien();
			lst = dNhanVien.getListDataBytenDangNhap(tenDangNhap);
		}
		catch
		{
			return null;
	...
	public bool deleteDataBytenDangNhap(string tenDangNhap)
	{
		...
		{
			DaoNhanVien dNhanVien = new DaoNhanVien();
			dNhanVien.deleteDataBytenDangNhap(tenDangNhap);
		}
		catch
		{
			return false;
	...
	public bool updateDataBytenDangNhap(DtoNhanVien data,string tenDangNhap)
	{
		...
		{
			DaoNhanVien dNhanVien = new DaoNhanVien();
			dNhanVien.updateDataBytenDangNhap(data,tenDangNhap);
		}
		catch
		{
			return false;
