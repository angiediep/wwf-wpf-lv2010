...
public class DaoQuanLy
{
    ...
    private void bindData1(SqlParameterCollection para, DtoQuanLy data, string tendangNhapCu)
    {
        ...
        para.AddWithValue("@xxx", tendangNhapCu);
    }
    ...
    public bool updateData(DtoQuanLy data, string tendangNhapCu)
    {
        ...
        cmd.CommandType = CommandType.StoredProcedure;
        bindData1(cmd.Parameters, data, tendangNhapCu);
        con.Open();
        cmd.ExecuteNonQuery();
        return true;
    }
